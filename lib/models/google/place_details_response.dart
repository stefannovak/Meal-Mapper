import 'nearby_search_response.dart';

class PlaceDetailsResponse {
  PlaceDetailsResponseResult? result;
  String? status;
  ...
  PlaceDetailsResponse.fromJson(Map<String, dynamic> json) {
    result = json['result'] != null
        ? new PlaceDetailsResponseResult.fromJson(json['result'])
        : null;
    status = json['status'];
  }
...
class PlaceDetailsResponseResult {
  ...
  PlaceDetailsResponseResult.fromJson(Map<String, dynamic> json) {
